...
\begin{figure}
	\centering
    \includegraphics[width=0.40\textwidth]{figures/results/unbounded_results.pdf}
...
\begin{figure}
	\centering
    \includegraphics[width=0.40\textwidth]{figures/results/bounded_results.pdf}
...
\begin{figure}[]
	\centering
    \includegraphics[width=0.40\textwidth]{figures/results/unbounded_results_scatter.pdf}
...
\begin{figure}
	\centering
    \includegraphics[width=0.40\textwidth]{figures/results/bounded_results_scatter.pdf}
...
\end{document}
</pre></body></html>Ztext/plain    ( F U l ~ ” šXY»‘             
              »œ